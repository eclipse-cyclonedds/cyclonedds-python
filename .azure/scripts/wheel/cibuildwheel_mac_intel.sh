...
CIBW_BEFORE_ALL+="cmake ../main -DCMAKE_INSTALL_PREFIX=$CYCLONEDDS_HOME $COMMON_CMAKE_OPTS -DCMAKE_OSX_ARCHITECTURES='x86_64' && "
...
export CIBW_BEFORE_TEST="pip install $REPO_HOME/src/pycdr"
